...
class HeadController:
    ...
    def __init__(self, sensitivity: float = 0.1, deadzone: float = 0.1):
        ...
        logger.info(f"Head controller initialized with sensitivity={sensitivity}, deadzone={deadzone}")
    ...
    def is_active(self, joycon_data: Dict[str, Any]) -> bool:
        ...
        return (left_stick_y > self.deadzone or 
                right_stick_x > self.deadzone or 
                right_stick_y > self.deadzone) 